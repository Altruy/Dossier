...
const SignIn = ({navigation}) => {
    ...
    const handleForgot=async()=>{
        ...
        Alert.alert(
            ...
            `Email has been sent to the email address: ${reset}\nFollow the instructions in the email to change the password\n\nDonot forget to check your spam folder.`,
            [
            {
                text: 'Okay'
            },
    ...
    return (
        <View style={styles.container}>
            <ForgotModal modal={show} setModal={setShow} text={reset} setText={setReset} handleNew={handleForgot}  />
